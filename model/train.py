...
def convert_classifier_data_to_tensor(train_epoch_filepaths,to_tensor=True):
    input_list = []
    output_list = []
...
def train_classifier(converted_data_path):
    ...
    for epoch in range(10000):
        ...
        for train_batch in range(train_batch_sum):
            ...
            train_input_list,train_output_list = convert_classifier_data_to_tensor(train_epoch_filepaths)
            #
        ...
        for test_batch in range(test_batch_sum):
            ...
            test_input_list,test_output_list = convert_classifier_data_to_tensor(test_epoch_filepaths)
...
def convert_regression_data_to_tensor(train_epoch_filepaths,to_tensor=True):
    input_list = []
    output_list = []
    for path in train_epoch_filepaths:
        json_data = json.load(open(path))
